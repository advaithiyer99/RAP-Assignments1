...
public class MathEx {
	public static void main(String[] args) {
		...
		// max and min
		System.out.println("Larger or two numbers: " + Math.max(4, 5));
		System.out.println("Smaller or two numbers: " + Math.min(4, 5));
		
		// square root
		System.out.println("Square root: " + Math.sqrt(64));
		
		// random: gets us a number between 0 and 1 (with decimals)
		System.out.println("Random number between 0 and 1 (with decimals): " + Math.random());
		
		
		// gives us a number between 0 and 9 (with decimals)
		System.out.println("Random number between 0 and 9 (with decimals): " + (Math.random() * 10));
		
		// gives us a number between 1 and 10 (with decimals)
		System.out.println("Random number between 1 and 10 (with decimals): " + ((Math.random() * 10) + 1));
		
		// gets us a number between 1 and 10
		System.out.println("Random number between 1 and 10: " + Math.floor(Math.random() * 10 + 1));
